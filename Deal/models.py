...
class Deal(models.Model):
    ...
    dateLoading = models.DateField()
    dateUnloading = models.DateField()
    ...
    typeLoading = models.ForeignKey(TypeLoading, on_delete=models.SET_NULL, null=True, related_name='typeLoading')
    ...
    weight = models.ForeignKey(Weight, on_delete=models.SET_NULL, null=True, related_name='weight')
    volume = models.ForeignKey(Volume, on_delete=models.SET_NULL, null=True, related_name='volume')
    dealStatus = models.ForeignKey(DealStatus, on_delete=models.SET_NULL, null=True, related_name='dealStatus')
    parametresTrailer = models.ForeignKey(ParametresTrailer, on_delete=models.SET_NULL, null=True, related_name='parametresTrailer')
    locationCargo = models.ForeignKey(LocationCargo, on_delete=models.SET_NULL, null=True, related_name='locationCargo')
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name='owner')
