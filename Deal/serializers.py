...
class OrderClientCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['priceClient', 'dateLoading', 'dateUnloading', 'autoReleaseYear', 'stateAwning', 'requirementsLoading',
                  'typeAuto', 'typeLoading', 'typeCargo', 'weight', 'weightMeasurementUnit', 'volume', 'locationCargo', 'user']
