...
urlpatterns = [
    path('deal/', ListOrderView.as_view(), name='deal'),
    path('deal/create/', CreateOrderView.as_view(), name = 'create_deal'),
    path('deal/update/<int:pk>', UpdateOrderView.as_view(), name = 'update_deal'),
    path('deal/delete/<int:pk>', DeleteOrderView.as_view(), name = 'delete_deal'),
